...
############################################################################
#
# MODULE:      r.dsm.import.sn
# AUTHOR(S):   Anika Weinmann
# PURPOSE:     Downloads DSM for Sachsen and aoi
...
# %module
# % description: Downloads DSM for Sachsen and aoi.
# % keyword: raster
# % keyword: import
# % keyword: DOM
# % keyword: DSM
...
TINDEX = (
    "https://github.com/mundialis/tile-indices/raw/main/DSM/SN/"
...
def main():
    """Main function of r.dsm.import.sn"""
